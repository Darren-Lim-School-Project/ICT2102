...
const CheckoutScreen = ({ navigation }) => {
  ...
  const handleCheckout = () => {
    ...
    console.log("> handleCheckout Entry point");

    db.collection("Employee")
      .doc(auth.currentUser.uid)
      .collection("Checkout")
      .add({
        Location: "1 Raffles Quay",
        CheckoutTime: currentDateWithMoment,
      });
  };
      ...
      <View style={styles.body}>
        ...
        <View style={styles.submitRowContainer}>
          <View style={styles.submitContentContainer}>
            <TouchableOpacity onPress={showCheckedOutAlert}>
          ...
          <View style={styles.drawSubmitCircle}>
            <TouchableOpacity onPress={showCheckedOutAlert}>
              <Image
                source={require("../../assets/checkinPic/cross-icon.png")}
